<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <button class="btn btn-success" @click="newArticle">Crear inventario</button>
          ...
          <tr v-for="inventario in inventarios.data" :key="inventario.id">
            ...
            <td>
              <div class="form-group bmd-form-group">
                <select class="form-control" name="tipomovimiento[]" v-model="tipomovimiento">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              >Alta Inventario Articulo</h5>
              <h5
                v-show="editMode"
                class="modal-title"
                id="exampleModalLabel"
              >Actualizar Cantidad Articulo</h5>
...
export default {
  ...
  methods: {
    ...
    updateArticle() {
      this.form
        .put("/api/inventarios/" + this.form.id)
        .then(() => {
    ...
    createMov() {
      ...
      this.mov
        .post("/api/moverinventario/" + this.mov.id)
        .then(() => {
